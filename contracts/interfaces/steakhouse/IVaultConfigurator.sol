...
interface IVaultConfigurator {
    ...
    function isDelegateModuleApproved(address module) external view returns (bool);
    ...
    event Stage(bytes32 indexed slot, Data indexed data, uint256 value, uint256 timestamp);
